...
public class Application {
    ...
    @Bean
    public CommandLineRunner demo(PersonRepository personRepository, EmailRepository emailRepository) {
        return (args) -> {

//            //Create Email Object
//            Email email = new Email("bigbob@aol.com");
//            //Set Person Object to Email Object
//            email.setPerson(person);
//            //Send to database
//            emailRepository.save(email);

            //Create Person Object
            Person person = new Person("Bob", "B", "Belcher");
            List<Email> emailList = new ArrayList<>();
            emailList.add(new Email("test@aol.com"));
            emailList.add(new Email("start@live.com"));
            emailList.add(new Email("birdman@cartoon.network"));
